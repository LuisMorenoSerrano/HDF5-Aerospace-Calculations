...
> Nota: Este documento recoge métricas obtenidas en la **rama `openmp`** (con paralelización OpenMP).
> La rama `main` es la versión serial y muestra tiempos sensiblemente mayores en generación (sin paralelización).
